...
$notifications = $database->get_notifications($email); $notifications_count = count($notifications);
$notifications_dropdown_item_text = 'Notifications'; if ($notifications_count > 0) { $notifications_dropdown_item_text
.= ' - <span class="fas fa-envelope"></span>'; } $seller = $database->is_seller($email); $user =
$database->is_user($email); $icon = $user ? 'fa-user' : ($seller ? 'fa-user-tie' : ''); $cart_button_status = $seller ?
'disabled' : ''; ?>
<header>
  <div class="container">
    <div class="row">
              ...
              <ul class="dropdown-menu" aria-labelledby="dropdown-button">
                <li>
                  ...
                  <a class="dropdown-item disabled" href="#"
                    ><?php echo $email; ?>
                    - <span class="fas <?php echo $icon; ?>"></span
                  ></a>
                  <?php } ?>
                </li>
              </ul>
            ...
            <form action="index.php">
              <div class="input-group">
                ...
                <input
                  ...
                  name="search"
                  value="<?php echo $template['search']; ?>"
                />
